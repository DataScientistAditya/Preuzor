    ...
    if request.method == "POST":
        ...
        if Serializer.is_valid():
            ...
            if User_Exist is None:
                ...
                Dict = {"Ud":Uuid,"Username":data["username"]}
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                User_Obj = Account.objects.get(UUid_Token = data["Uid"])
                Data_toSaved = LettersTest(user = User_Obj, Score = data["Score"] )
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_Letterstest = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_SentenceTest = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_Wordsstest = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_Storiestest = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
...
def Verify(requset, token):
    try:
        Valid = Account.objects.all().filter(UUid_Token = token).values("UUid_Token")[0]["UUid_Token"]
        if Valid is not None:
            Account.objects.all().filter(UUid_Token = token).update(is_email_varified = True)
            return HttpResponse("Thank you for verifying your account,Please Login to Your Account")
        else:
            pass
    except:
        return HttpResponse("Your Acoount is not verified,Please return to Registration")
...
def Retake(request):
    if request.method == "POST":
        data = JSONParser().parse(request)
        try:
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_Letterstest = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_SentenceTest = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_Wordsstest = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_Storiestest = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestletters = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestSentences = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestWords = False)
            Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestStories = False)
            Dict ={"Ud":data["Uid"]}
            return JsonResponse(Dict,status=201)
        except:
...
def GetIntelligenceResult(request):
    if request.method == "POST":
        ...
        try:
            ...
            Intra_List = []
            Inter_List = []
            Valid = Account.objects.all().filter(UUid_Token = data["Uid"]).values("UUid_Token")[0]["UUid_Token"]
            User_Obj = Account.objects.get(UUid_Token = data["Uid"])
            ...
            if Maxvalue_Index == 0:
                ...
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_IntelligenceTest = True)
                return JsonResponse(Dict,status=201)
            if Maxvalue_Index == 1:
                Dict["Character"] = "Strong ability"
...
def SendInventoryResult(request):
    if request.method=="POST":
        ...
        Dict={}
        try:
            Account.objects.all().filter(UUid_Token = data["Uid"]).values("UUid_Token")[0]["UUid_Token"]
            User_Obj = Account.objects.get(UUid_Token = data["Uid"])
...
def GetCompletedTest(request):
    if request.method=="POST":
        ...
        try:
            ...
            Is_LetterTest = Account.objects.all().filter(UUid_Token=Uid_Token).values("is_Letterstest")[0]["is_Letterstest"]
            Is_WordsTest = Account.objects.all().filter(UUid_Token=Uid_Token).values("is_Wordsstest")[0]["is_Wordsstest"]
            Is_SentenceTest = Account.objects.all().filter(UUid_Token=Uid_Token).values("is_SentenceTest")[0]["is_SentenceTest"]
            Is_StoryTest = Account.objects.all().filter(UUid_Token=Uid_Token).values("is_Storiestest")[0]["is_Storiestest"]
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestletters = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestSentences = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestWords = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if Valid_User is not None:
                ...
                Data_toSaved.save()
                Account.objects.all().filter(UUid_Token = data["Uid"]).update(is_PostTestStories = True)
                Dict ={"Ud":Valid_User}
                return JsonResponse(Dict,status=201)
        except:
            Dict ={"Ud":"Not a valid user"}
